...
function usage() {
  ...
  echo ""
  echo "Example: ./removeBlob.sh service-registry-broker.jar"
  echo "This would remove all references to the 'my-service-broker.jar' from 'blobs/srb_broker', 'config/blobs.yml' and .blobs folder "
  echo ""
}
